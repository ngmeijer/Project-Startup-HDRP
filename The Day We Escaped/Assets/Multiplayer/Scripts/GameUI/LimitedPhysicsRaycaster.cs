...
/// <summary>
/// Copied from unity source to expose a rayCastDistance so the events will be limited by distance
/// </summary>
[AddComponentMenu("Event/Limited Physics Raycaster")]
[RequireComponent(typeof(Camera))]
public class LimitedPhysicsRaycaster : BaseRaycaster
{
    [Range(0, 100)]
    ...
    protected LimitedPhysicsRaycaster()
    {
    }
